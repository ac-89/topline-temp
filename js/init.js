    ...
    $(".quick-quote").each(function () {
      ...
      formInstance.submit(function () {
        ...
        $("#Quote-message").slideUp(750, function () {
          ...
          $("#quote-submit")
            .after(
              '<img src="images/assets/ring.svg" class="loader" width="22px" height="22px" />'
            )
            .attr("disabled", "disabled");
          ...
          $.post(
            ...
            function (data) {
              ...
              $(".quick-quote img.loader").fadeOut("slow", function () {
                $(this).remove();
              });
              $("#quote-submit").removeAttr("disabled");
              if (data.match("success") != null)
                $(".quick-quote").slideUp("slow");
            }
          );
        });
        return false;
        ...
        $("#question-message").slideUp(750, function () {
          ...
          $.post(
            ...
            function (data) {
              ...
              $(".ask-question-form img.loader").fadeOut("slow", function () {
                $(this).remove();
              });
              $("#question-submit").removeAttr("disabled");
              if (data.match("success") !== null)
                $(".ask-question-form").slideUp("slow");
            }
          );
        });
        return false;
  ...
  GREENSKEEPER.OwlCarousel = function () {
    $(".owl-carousel").each(function () {
      ...
      var carouselArrows =
        carouselInstance.attr("data-arrows") == "yes" ? true : false;
      var carouselSingle =
        carouselInstance.attr("data-single-item") == "yes" ? true : false;
      var carouselStyle = carouselInstance.attr("data-style")
        ? carouselInstance.attr("data-style")
        : "fade";
    ...
    $(".cProgress").each(function () {
      ...
      cproInstance
        ...
        .on("circle-animation-progress", function (event, progress) {
          cproInstance
            .find("strong")
            .html(parseInt(cprocomplete * progress, 10) + "<i>%</i>");
        });
    });
  };
