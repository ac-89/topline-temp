...
!(function (a) {
  ...
  var b = function (c, d, e) {
    e && (e.stopPropagation(), e.preventDefault()),
      ...
      (this.remove = b.prototype.destroy),
  ...
  (b.VERSION = "1.6.0"),
    ...
    (b.prototype = {
      ...
      createLi: function () {
        ...
        return (
          this.$element.find("option").each(function () {
            ...
            if (
              ("" !== j &&
                (d.is(":disabled") || d.parent().is(":disabled")) &&
                (j = "<span>" + j + "</span>"),
              d.data("content") ||
                (h = j + '<span class="text">' + h + i + "</span>"),
              ...
              if (0 === d.index()) {
                var k = d.parent().attr("label"),
                  l =
                    void 0 !== d.parent().data("subtext")
                      ? '<small class="muted text-muted">' +
                        d.parent().data("subtext") +
                        "</small>"
                      : "",
                  m = d.parent().data("icon")
                    ? '<i class="' +
                      b.options.iconBase +
                      " " +
                      d.parent().data("icon") +
                  ...
                  c.push(
                    0 !== d[0].index
                      ? '<div class="div-contain"><div class="divider"></div></div><dt>' +
                          k +
                          "</dt>" +
                          b.createA(h, "opt " + f, g, e)
                      : "<dt>" + k + "</dt>" + b.createA(h, "opt " + f, g, e)
                  );
      ...
      createA: function (a, b, c, d) {
        return (
          ...
          c +
          '"' +
          ("undefined" != typeof d ? 'data-optgroup="' + d + '"' : "") +
          ">" +
          a +
          '<i class="' +
      ...
      render: function (b) {
        ...
        if (
          ...
          ((f.length > 1 && d.length > f[1]) ||
            (1 == f.length && d.length >= 2)) &&
            (e = this.options.countSelectedText
              .replace("{0}", d.length)
              .replace(
                "{1}",
                this.$element.find(
                  'option:not([data-divider="true"], [data-hidden="true"])' + g
                ).length
              ));
        }
        (this.options.title = this.$element.attr("title")),
          ...
          this.$button.attr(
            "title",
            a.trim(a("<div/>").html(e).text()).replace(/\s\s+/g, " ")
          ),
        ...
        if (this.options.size !== !1) {
          var a = this.$menu
            ...
            e = this.options.liveSearch
              ? b.find(".bootstrap-select-searchbox").outerHeight()
              : 0,
          ...
          this.$menu.on("click", "li a", function (c) {
            ...
            if (
                ...
                if (
                  ...
                  if ((k && m) || (l && n))
                    if (k && 1 == k)
                      ...
                      b.$menu
                        .find(".selected")
                        .has('a[data-optgroup="' + s + '"]')
                        .removeClass("selected"),
                        b.setSelected(d, !0);
                    } else
                      o[2] &&
                        ((p = p.replace("{var}", o[2][k > 1 ? 0 : 1])),
                        (q = q.replace("{var}", o[2][l > 1 ? 0 : 1]))),
                        h.prop("selected", !1),
                        b.$menu.append(r),
                        k &&
                          m &&
                          (r.append(a("<div>" + p + "</div>")),
                          b.$element.trigger("maxReached.bs.select")),
                        l &&
                          n &&
                          (r.append(a("<div>" + q + "</div>")),
              ...
              b.multiple
                ...
                : b.$button.focus(),
                ((e != b.$element.val() && b.multiple) ||
                  (f != b.$element.prop("selectedIndex") && !b.multiple)) &&
                  b.$element.change();
            }
          }),
          this.$menu.on(
      ...
      keydown: function (b) {
        ...
        if (
          ...
          !n &&
            ...
            (l.options.container
              ? l.$newElement.trigger("click")
              : (l.setSize(), l.$menu.parent().addClass("open"), (n = !0)),
            l.$searchbox.focus()),
          l.options.liveSearch &&
            (/(^9$|27)/.test(b.keyCode.toString(10)) &&
              n &&
              0 === l.$menu.find(".active").length &&
              (b.preventDefault(),
          ...
          if (/(38|40)/.test(b.keyCode.toString(10)))
            ...
            d.each(function () {
              ...
              q != o[b.keyCode]
                ? ((p = 1), a(document).data("keycount", p))
                : p >= r.length &&
                  (a(document).data("keycount", 0), p > r.length && (p = 1)),
              d.eq(r[p - 1]).focus();
          }
          /(13|32)/.test(b.keyCode.toString(10)) &&
            ...
            l.options.liveSearch
              ? /(32)/.test(b.keyCode.toString(10)) ||
                (l.$menu.find(".active a").click(), c.focus())
              : a(":focus").click(),
            a(document).data("keycount", 0)),
            ((/(^9$|27)/.test(b.keyCode.toString(10)) &&
              n &&
              (l.multiple || l.options.liveSearch)) ||
              (/(27)/.test(b.keyCode.toString(10)) && !n)) &&
              (l.$menu.parent().removeClass("open"), l.$button.focus());
        }
      },
      hide: function () {
      ...
      var e,
        ...
        g = this.each(function () {
          if (a(this).is("select")) {
            ...
            if ("string" == typeof c) {
              var k = c;
              h[k] instanceof Function
                ? ([].shift.apply(f), (e = h[k].apply(h, f)))
                : (e = h.options[k]);
            }
          }
        });
    ...
    (a.fn.selectpicker.Constructor = b),
    a(document)
      .data("keycount", 0)
      .on(
        "keydown",
...
(function (e) {
  ...
  var s = function (t) {
    var n = { byRow: true, remove: false, property: "height" };
    if (typeof t === "object") {
      return e.extend(n, t);
    }
    if (typeof t === "boolean") {
  ...
  o._apply = function (t, n) {
    ...
    if (o._maintainScroll)
      e(window).scrollTop((l / c) * e("html").outerHeight(true));
    return this;
  };
